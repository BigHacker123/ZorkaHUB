...
ZORKA.Games = {
	...
	["1168263273"] = {
		Name = "Bad Business",
		Script = ZORKA.Debug and readfile("ZorkaHUB/Bad Business/ClientBB.lua") or game:HttpGetAsync("https://github.com/ZuhuInc/ZorkaHUB/blob/main/Bad%20Business/ClientBB.lua")
	}
}
