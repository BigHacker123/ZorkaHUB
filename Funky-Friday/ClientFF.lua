...
local SaveManager = {} do
    ...
    function SaveManager:Save(name)
        local fullPath = 'ZORKA_funky_friday/configs/' .. name .. '.json'
    ...
    function SaveManager:Load(name)
        local file = 'ZORKA_funky_friday/configs/' .. name .. '.json'
    ...
    function SaveManager.Refresh()
        local list = listfiles('ZORKA_funky_friday/configs')
...
Groups.Credits = Tabs.Miscellaneous:AddRightGroupbox('Credits')
    Groups.Credits:AddLabel('<font color="#de6cff">Zuhu</font>')
    Groups.Credits:AddLabel('<font color="#3da5ff">ZoraX</font>')
    Groups.Credits:AddLabel('<font color="#3da5ff">LtW</font>')
    Groups.Credits:AddLabel('<font color="#3da5ff">IceQbe</font>')
...
if type(readfile) == 'function' and type(writefile) == 'function' and type(makefolder) == 'function' and type(isfolder) == 'function' then
    makefolder('ZORKA_funky_friday')
    makefolder('ZORKA_funky_friday\\configs')
...
do
    ...
    themeManager:SetFolder('ZORKA_funky_friday')
